...
downIcon(idx){
  ...
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill={ idx+1 !==length ? "rgb(188, 71, 73)":"#6c757d" } class="bi bi-caret-right-fill" viewBox="0 0 16 16">
...
removeIcon(){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="black" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
...
trophyIcon(){
  return(
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="#FFC107" class="bi bi-trophy-fill" viewBox="0 0 16 16">
          ...
          <div>
            <div class='container'>
              ...
              {movies ? movies.map((result, idx)=>{
                  ...
                  return(
                      <div key={idx} class='col-xs-12 col-sm-6 col-md-4 col-lg-2 pb-3 '>
