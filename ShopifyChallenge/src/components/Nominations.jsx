...
downIcon(idx){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill={ idx !==4 ? "rgb(188, 71, 73)":"#6c757d" } class="bi bi-caret-right-fill" viewBox="0 0 16 16">
...
removeIcon(){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="black" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
...
trophyIcon(){
  return(
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#FFC107" class="bi bi-trophy-fill" viewBox="0 0 16 16">
...
upIcon(idx){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill={idx !==0 ? "rgb(188, 71, 73)":"#6c757d" } class="bi bi-caret-left-fill" viewBox="0 0 16 16">
